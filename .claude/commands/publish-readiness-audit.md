---
# DO NOT EDIT — generated from .agents/workflows/publish-readiness-audit.md (agents-md-schema.md rule 7). Edit the source.
...
---
<!-- DO NOT EDIT. Generated from .agents/workflows/publish-readiness-audit.md by the AGENTS.md adapter step
