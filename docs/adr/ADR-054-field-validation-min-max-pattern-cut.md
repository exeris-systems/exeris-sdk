...
- [`MIGRATION.md`](../../MIGRATION.md) — the 0.8.x → 0.9.x section: schema bump, zero-bounds semantics, `ValidationMetadata` deprecation, reader parity.
