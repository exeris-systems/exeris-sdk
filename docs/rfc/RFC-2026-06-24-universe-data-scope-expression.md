...
### Build trigger — (1) met, (2) pending; build NOT started
...
| **Date**             | 2026-07-02 |
| **Resulting ADR(s)** | Kernel side: **in-place ADR-012 amendment**, no new `adr-index` number (per RFC-2026-07-02). SDK side: thin "data-scope expression" ADR still TBD — reserved when the build starts (trigger (2)). |
